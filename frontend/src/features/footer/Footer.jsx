    ...
    >
      ...
      >
        ...
        <Stack rowGap={"1rem"} padding={"1rem"}>
          ...
          <Typography sx={labelStyles}>+1-99999-9999</Typography>
        </Stack>

        <Stack rowGap={"1rem"} padding={"1rem"}>
          <Typography variant="h6">Account</Typography>
          <Typography sx={labelStyles} component={Link} to={"/profile"}>
            My Account
          </Typography>
          <Typography sx={labelStyles} component={Link} to={"/cart"}>
            Cart
          </Typography>
          <Typography sx={labelStyles} component={Link} to={"/wishlist"}>
            Wishlist
          </Typography>
          <Typography sx={labelStyles} component={Link} to={"/"}>
            Shop
          </Typography>
        </Stack>
